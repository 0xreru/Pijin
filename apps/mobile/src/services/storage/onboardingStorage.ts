...
const ONBOARDING_COMPLETE_KEY = 'pijn.onboarding_complete';
const PIN_KEY = 'pijn.user_pin';
const PIN_SECURE_KEY = 'pijn.user_pin_secure';
const PHONE_NUMBER_KEY = 'pijn.user_phone';
